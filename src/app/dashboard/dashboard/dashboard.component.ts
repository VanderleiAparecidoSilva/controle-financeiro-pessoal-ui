...
import { DashboardService, Filter } from '../dashboard.service';
...
export class DashboardComponent implements OnInit {
  ...
  optionsCreditSynthetic: any;
  optionsDebitSynthetic: any;
  optionsCreditAnalytical: any;
  optionsDebitAnalytical: any;
  ...
  calendarPortuguese: any;
    ...
    showCharts() {
      ...
      this.configurarGraficoPizzaDebitAnalytical();
    }
    ...
    defineChartOptions() {
      this.optionsCreditSynthetic = {
        ...
        showTooltips: true,
          title: {
            display: true,
            text: 'Lançamentos de crédito por centro de custo (Sintético)',
            fontSize: 16
        },
        legend: {
          position: 'bottom'
      ...
      this.optionsDebitSynthetic = {
        ...
        showTooltips: true,
          title: {
            display: true,
            text: 'Lançamentos de débito por centro de custo (Sintético)',
            fontSize: 16
        },
        legend: {
          position: 'bottom'
      ...
      this.optionsCreditAnalytical = {
        ...
        showTooltips: true,
          title: {
            display: true,
            text: 'Lançamentos de crédito por centro de custo (Analítico)',
            fontSize: 16
        },
        legend: {
          position: 'bottom'
      ...
      this.optionsDebitAnalytical = {
        ...
        showTooltips: true,
          title: {
            display: true,
            text: 'Lançamentos de débito por centro de custo (Analítico)',
            fontSize: 16
        },
        legend: {
          position: 'bottom'
    ...
    configurarGraficoPizzaCreditSynthetic() {
      this.dashboardService.lancamentosCreditoPorCentroCustoSintetico(this.filter)
      .then(dados => {
        this.pieChartDataCreditSynthetic = {
    ...
    configurarGraficoPizzaDebitSynthetic() {
      this.dashboardService.lancamentosDebitoPorCentroCustoSintetico(this.filter)
      .then(dados => {
        this.pieChartDataDebitSynthetic = {
          labels: dados.map(dado => dado.centroCusto.nome),
          datasets: [
            {
              data: dados.map(dado => dado.total),
    ...
    configurarGraficoPizzaCreditAnalytical() {
      this.dashboardService.lancamentosCreditoPorCentroCustoAnalitico(this.filter)
        .then(dados => {
          this.pieChartDataCreditAnalytical = {
            labels: dados.map(dado => dado.centroCusto.nome),
            datasets: [
              {
                data: dados.map(dado => dado.total),
    ...
    configurarGraficoPizzaDebitAnalytical() {
      this.dashboardService.lancamentosDebitoPorCentroCustoAnalitico(this.filter)
        .then(dados => {
          this.pieChartDataDebitAnalytical = {
            labels: dados.map(dado => dado.centroCusto.nome),
            datasets: [
              {
                data: dados.map(dado => dado.total),
