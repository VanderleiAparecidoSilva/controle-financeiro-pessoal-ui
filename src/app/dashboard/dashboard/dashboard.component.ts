...
export class DashboardComponent implements OnInit {
  ...
  options = {
    ...
    ngOnInit() {
      ...
      this.configurarGraficoPizzaCredit();
      this.configurarGraficoPizzaDebit();
    }
    ...
    configurarGraficoPizzaCredit() {
      this.dashboardService.lancamentosCreditoPorCentroCusto(this.filter)
        .then(dados => {
    ...
    configurarGraficoPizzaDebit() {
      this.dashboardService.lancamentosDebitoPorCentroCusto(this.filter)
        .then(dados => {
          this.pieChartDataDebit = {
            labels: dados.map(dado => dado.centroCusto.nome),
            datasets: [
              {
                data: dados.map(dado => dado.total),
